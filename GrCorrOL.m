function [Gengol,Logol,ENSgol,Genol,Loadol,ENSol,OverChargeol,savingtxt]=GrCorrOL(Genoli,Loadoli,ENSoli,OverChargeoli,lf,BUS,BRANCH,Title,UCf,t,savefilename,Ymatriz,optiontype)
...
Type=Title.case;
timercode=clock();
savingtxt=strcat(Type,'Correction',savefilename,'OL',num2str(t),...

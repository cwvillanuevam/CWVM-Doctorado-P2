function [Gengmin,Logmin,ENSgmin,Genmin,Loadmin,ENSmin,OverChargemin]=GrCorrMIN(lf,BUS,BRANCH,Title,Genmini,Loadmini,ENSmini,OverChargemini,UCf,t,lmin,savefilename,Ymatriz)
...
Type=Title.case;
timercode=clock();
savingtxt=strcat(Type,'Correction',savefilename,'MIN',num2str(t),...
